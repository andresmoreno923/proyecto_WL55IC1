...
class tlv {
    ...
    decode() {
        ...
        console.log("group_b16: ", this.group_b16);
        console.log("group_b10: ", this.group_b10);
    ...
    decode_date_time() {
        ...
        console.log("fecha(AA/MM/DD): ", this.year, this.month, this.day);
        console.log("hora: ", this.hour, this.min, this.sec);
    ...
    error_sensor_id(id) {
        ...
        console.log("id:", id, "sensor type:", idError[id]);
    ...
    error_code(id) {
        ...
        console.log("id:", id, "error type:", errorType[id]);
...
var parsed = {};
// String de entrada proporcionado
const inputString1 = "24191616123456781C1303010000001B0109000003EC22314158";


const inputString2 = "241916161234567858";

console.log("inputString: ", inputString1);

const instanciaTlv = new tlv(inputString1, parsed);

// Llamar a los métodos necesarios para procesar la entrada
instanciaTlv.split_str();
instanciaTlv.cs_rec();
parsed = instanciaTlv.decode();
